...
import Settings from '../../Endpoints/Llama/Settings.jsx';
import Examples from '../../Endpoints/Llama/Examples.jsx';
import { cn } from '~/utils/';

import store from '~/store';

function LlamaOptions() {
  ...
  if (endpoint !== 'llama') return null;
  if (conversationId !== 'new') return null;

  const models = endpointsConfig?.['llama']?.['availableModels'] || [];
